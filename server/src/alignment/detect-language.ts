 ...
 *
 * That modest requirement used to be met by running a speech model over a clip
 * of the narration, which needed a 60 MB download, a whisper binary, and a
 * minute of CPU — to answer a question the text itself answers for free. Script
...
const MARKERS: Record<string, string[]> = {
  en: ['the', 'and', 'of', 'that', 'was', 'with', 'his', 'her', 'they', 'have', 'from', 'this', 'were', 'which', 'been', 'their'],
  de: ['der', 'die', 'und', 'das', 'nicht', 'ich', 'sie', 'mit', 'ein', 'eine', 'auch', 'war', 'den', 'dem', 'ist', 'sich', 'aber', 'noch'],
  fr: ['les', 'des', 'pas', 'une', 'dans', 'pour', 'qui', 'elle', 'sur', 'avec', 'était', 'mais', 'ses', 'aux', 'cette', 'tout', 'est', 'je'],
  es: ['los', 'las', 'una', 'por', 'para', 'como', 'pero', 'más', 'sus', 'del', 'ella', 'sobre', 'muy', 'había', 'cuando', 'con'],
  it: ['che', 'non', 'della', 'delle', 'degli', 'nel', 'nella', 'sono', 'anche', 'alla', 'gli', 'più', 'questo', 'dei', 'il', 'lo'],
  pt: ['não', 'uma', 'com', 'para', 'como', 'mais', 'dos', 'das', 'seu', 'pelo', 'ele', 'foi', 'muito', 'quando', 'então', 'já'],
  nl: ['het', 'een', 'niet', 'van', 'dat', 'zijn', 'met', 'maar', 'voor', 'aan', 'ook', 'werd', 'hij', 'deze', 'naar', 'over', 'door'],
};
